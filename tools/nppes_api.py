...
class NppesApiTool:
    ...
    def search_nppes(self, first_name: str = "", last_name: str = "", organization_name: str = "", city: str = "", state: str = "", limit: int = 10) -> List[Dict[str, Any]]:
        """
        ...
        if len(params) <= 2:
            return [{"error": "You must provide at least one search parameter (e.g., first_name, last_name, organization_name)."}]
